...
UNIFIED_NODES: List[Dict[str, Any]] = [
    ...
    {"id":"decide_branch","goal":"Decide experiment vs model vs architecture vs kernel/workflow change","inputs":["hypothesis_id"],"preconditions":["hypothesis_ready"],"actions":["branch_decide"],"outputs":["branch"],"success":["branch_chosen"],"failure":["unclear"],"next":["experiment","propose_architecture","modify_code"]},
    ...
    {"id":"propose_architecture","goal":"Paradigm search: justify abstraction replacement before code edit","inputs":["hypothesis_id"],"preconditions":["branch==architecture"],"actions":["leap_justify"],"outputs":["leap_proposal"],"success":["leap_justified"],"failure":["leap_rejected"],"next":["modify_code"]},
