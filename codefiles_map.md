...
│   │   │   ├── [X] hypothesis_engine.py [387 LOC, 2034 tokens]
│   │   │   ├── validation_engine.py
│   │   │   ├── [X] contradiction_gate.py [131 LOC, 1432 tokens]
...
│   │   │   ├── [X] memory_engine.py [223 LOC, 1488 tokens]
│   │   │   ├── [] episodic_memory.py [308 LOC, 1781 tokens]
│   │   │   ├── [X] semantic_memory.py [436 LOC, 2604 tokens]
│   │   │   └── pattern_memory.py
...
│   │   ├── virtual_silicon/ [20742 LOC, 156028 tokens]
...
│   │   │   ├── [] ChatGpt56_luna.md [588 LOC, 2235 tokens]
...
├── project_docs/ [6529 LOC, 29320 tokens]
...
│   │   ├── [X] main_agent.json [67 LOC, 255 tokens]
│   │   ├── [] Agent_graph.json [66 LOC, 1368 tokens]
│   │   ├── [X] kernel_ops.json [37 LOC, 891 tokens]
│   │   ├── [] minimal_context.json [44 LOC, 1121 tokens]
│   │   ├── [X] popu_sim_dev.md [176 LOC, 1285 tokens]
│   │   ├── [] node_sections.md [41 LOC, 476 tokens]
│   │   ├── [X] popu_sim_dev.json [34 LOC, 762 tokens]
│   │   ├── [X] kernel_ops.md [131 LOC, 1147 tokens]
...
│   │   │   └── [X] graph.json [41 LOC, 618 tokens]
