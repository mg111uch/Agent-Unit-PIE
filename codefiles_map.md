...
├── codebase/ [76086 LOC, 491490 tokens]
...
│   │   ├── simulation_agent.py
│   │   └── pattern_agent.py
│   ├── agent_tools/ [4339 LOC, 36151 tokens]
...
│   ├── prompt_fragments/ [145 LOC, 2256 tokens]
...
│   ├── modules/ [39085 LOC, 224668 tokens]
...
│   │   ├── virtual_silicon/ [15409 LOC, 87128 tokens]
│   │   │   ├── vse/ [10870 LOC, 56177 tokens]
...
│   │   │   │   ├── [] cli_args.py [186 LOC, 907 tokens]
│   │   │   │   ├── [] workload.py [497 LOC, 2656 tokens]
│   │   │   │   ├── [] __init__.py [8 LOC, 53 tokens]
│   │   │   │   ├── [] cli.py [335 LOC, 1570 tokens]
│   │   │   │   └── [] cli_search.py [421 LOC, 2051 tokens]
│   │   │   ├── tests/ [3261 LOC, 17653 tokens]
...
│   │   │   ├── [] roadmap.md [218 LOC, 1291 tokens]
│   │   │   ├── conftest.py
│   │   │   ├── [] README.md [317 LOC, 3898 tokens]
│   │   │   └── [] usage.md [711 LOC, 7989 tokens]
...
│   ├── agent_core/ [13936 LOC, 123720 tokens]
│   │   ├── server/ [827 LOC, 6350 tokens]
...
│   │   │   ├── [] __init__.py [558 LOC, 7980 tokens]
│   │   │   ├── [] tool_introspect.py [392 LOC, 3679 tokens]
...
│           ├── profile/
│           └── system_summery.md
├── system_devpt_reports/ [2418 LOC, 31594 tokens]
...
├── code_dump.txt
├── [] codefiles_map.md [555 LOC, 10025 tokens]
