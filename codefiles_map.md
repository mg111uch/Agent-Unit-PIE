...
│   ├── [X] render_graph.py [256 LOC, 2711 tokens]
│   └── [] validate_capabilities.py [126 LOC, 1196 tokens]
├── codebase/ [55818 LOC, 357943 tokens]
...
│   ├── prompt_fragments/ [169 LOC, 3158 tokens]
│   │   ├── [] meta_playbook.md [6 LOC, 205 tokens]
...
│   ├── agent_core/ [11110 LOC, 97096 tokens]
...
│   │   │   ├── [] __init__.py [546 LOC, 8091 tokens]
...
│   │   │   ├── [] registry.py [310 LOC, 2600 tokens]
│   │   │   └── [] types.py [41 LOC, 247 tokens]
│   │   ├── loop/ [1577 LOC, 12224 tokens]
│   │   │   ├── [] streaming.py [118 LOC, 724 tokens]
│   │   │   ├── [] _helpers.py [173 LOC, 1346 tokens]
│   │   │   ├── [] stepper.py [366 LOC, 3115 tokens]
...
│   ├── __init__.py
│   ├── tui_output.txt
│   ├── [] config.json [115 LOC, 913 tokens]
...
├── data/ [1265 LOC, 15217 tokens]
│   ├── chroma_db/
│   ├── workflows/ [631 LOC, 9200 tokens]
│   │   ├── [X] minimal_context.html [278 LOC, 3765 tokens]
│   │   └── [X] implement_fix.html [353 LOC, 5435 tokens]
│   ├── memory/
│   │   ├── semantic/
│   │   ├── working/
│   │   ├── hypotheses/
...
│           ├── profile/
│           └── system_summery.md
├── system_devpt_reports/ [1797 LOC, 24509 tokens]
...
│   ├── agent_core/ [262 LOC, 5369 tokens]
│   │   ├── [] roadmap.md [17 LOC, 118 tokens]
│   │   ├── [] status.md [44 LOC, 1366 tokens]
│   │   └── [X] README.md [201 LOC, 3885 tokens]
│   ├── [] TODO.md [41 LOC, 1299 tokens]
│   ├── [] FeatureIdeas.md [148 LOC, 1857 tokens]
│   └── [X] FixesIssues.md [170 LOC, 2749 tokens]
├── [] opencode.json [16 LOC, 163 tokens]
├── [X] Agent_graph.html [196 LOC, 3066 tokens]
├── context_dump.txt
├── [X] AGENTS.md [30 LOC, 391 tokens]
├── code_dump.txt
├── [] codefiles_map.md [473 LOC, 8398 tokens]
