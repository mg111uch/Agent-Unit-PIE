...
### FILE_MAP Tree
├── sessions_analysis/ [354 LOC, 7380 tokens]
...
├── codebase/ [85343 LOC, 601121 tokens]
...
│   ├── modules/ [46652 LOC, 318636 tokens]
...
│   │   ├── virtual_silicon/ [20725 LOC, 156987 tokens]
...
│   │   │   ├── [X] roadmap.md [264 LOC, 1693 tokens]
│   │   │   ├── [X] Findings.md [98 LOC, 3161 tokens]
│   │   │   ├── [] conftest.py [43 LOC, 342 tokens]
│   │   │   ├── [] ChatGpt56_luna.md [434 LOC, 3125 tokens]
│   │   │   ├── [X] IssuesFix.md [146 LOC, 2354 tokens]
│   │   │   ├── [X] README.md [300 LOC, 3337 tokens]
│   │   │   └── [X] usage.md [474 LOC, 5342 tokens]
...
├── data/ [1191 LOC, 13515 tokens]
│   ├── chroma_db/
│   ├── workflows/ [557 LOC, 7498 tokens]
...
│           ├── profile/
│           └── system_summery.md
├── system_devpt_reports/ [2644 LOC, 35056 tokens]
...
├── [] codefiles_map.md [676 LOC, 12732 tokens]
