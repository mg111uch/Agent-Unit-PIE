...
├── codebase/ [67741 LOC, 502105 tokens]
...
│   │   ├── simulation_agent.py
│   │   └── pattern_agent.py
│   ├── agent_tools/ [3709 LOC, 29411 tokens]
...
│   │   ├── [] condense_transcript.py [316 LOC, 2496 tokens]
...
│   ├── prompt_fragments/ [184 LOC, 3388 tokens]
...
│   │   ├── [] response_contract.md [35 LOC, 494 tokens]
│   │   ├── [] file_ops_workflow.md [21 LOC, 585 tokens]
...
│   ├── modules/ [22945 LOC, 129931 tokens]
...
│   ├── agent_core/ [11612 LOC, 101584 tokens]
│   │   ├── server/ [840 LOC, 6524 tokens]
│   │   │   ├── [] ws_handler.py [412 LOC, 3213 tokens]
│   │   │   ├── [] routes.py [128 LOC, 1080 tokens]
│   │   │   ├── [] auth.py [36 LOC, 230 tokens]
│   │   │   ├── [] __init__.py [177 LOC, 1314 tokens]
│   │   │   └── [] audit.py [87 LOC, 687 tokens]
│   │   ├── tools/ [6169 LOC, 58182 tokens]
...
│   │   │   └── [X] engine.py [387 LOC, 2848 tokens]
│   │   ├── providers/ [1153 LOC, 9756 tokens]
│   │   │   ├── [X] openrouter_provider.py [209 LOC, 1509 tokens]
│   │   │   ├── [] ollama_provider.py [133 LOC, 1034 tokens]
│   │   │   ├── [] mock_provider.py [255 LOC, 2933 tokens]
│   │   │   ├── [] __init__.py [55 LOC, 433 tokens]
│   │   │   └── [X] gemini_provider.py [501 LOC, 3847 tokens]
...
│   │   ├── [] message_store.py [172 LOC, 1386 tokens]
...
│   ├── __init__.py
│   ├── [] tui_output.txt [10497 LOC, 124775 tokens]
│   ├── [] config.json [119 LOC, 956 tokens]
│   ├── [] tool_client.py [203 LOC, 2213 tokens]
│   ├── [] .env.enc [1 LOC, 222 tokens]
│   ├── [] condensed2.md [303 LOC, 2693 tokens]
│   └── [X] condensed.txt [344 LOC, 8997 tokens]
├── project_docs/ [6732 LOC, 33387 tokens]
│   ├── [] MCP_ADAPTERS.md [219 LOC, 1399 tokens]
│   ├── [] GPT_5-5_Chat.md [4962 LOC, 18724 tokens]
│   ├── [] backupPlans.md [175 LOC, 3709 tokens]
│   ├── [] PROBLEM_STATEMENT.md [147 LOC, 2171 tokens]
...
│           ├── profile/
│           └── system_summery.md
├── system_devpt_reports/ [2064 LOC, 28831 tokens]
