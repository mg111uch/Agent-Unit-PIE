...
├── codebase/ [52983 LOC, 331772 tokens]
...
│   │   ├── [] test_file_ops_pipeline.py [385 LOC, 3853 tokens]
...
│   ├── agent_core/ [7357 LOC, 62248 tokens]
...
│   │   │   └── [] engine.py [589 LOC, 4189 tokens]
│   │   ├── llm/ [1115 LOC, 9236 tokens]
...
│   ├── [] TODO.md [28 LOC, 730 tokens]
│   ├── [] Devpt_phases.md [333 LOC, 2918 tokens]
│   ├── [] agent_test_prompts.md [87 LOC, 773 tokens]
...
│           ├── profile/
│           └── system_summery.md
├── system_devpt_reports/ [1827 LOC, 22757 tokens]
...
│   ├── agent_core/ [339 LOC, 5178 tokens]
│   │   ├── [] roadmap.md [18 LOC, 131 tokens]
│   │   ├── [] status.md [32 LOC, 859 tokens]
│   │   └── [] README.md [289 LOC, 4188 tokens]
│   ├── [] FeatureIdeas.md [139 LOC, 1946 tokens]
│   └── [] FixesIssues.md [173 LOC, 2398 tokens]
├── [] opencode.json [16 LOC, 163 tokens]
├── [] Agent_graph.html [196 LOC, 3066 tokens]
├── context_dump.txt
├── [] AGENTS.md [110 LOC, 1647 tokens]
├── code_dump.txt
├── [] codefiles_map.md [456 LOC, 8119 tokens]
├── [] .gitignore [11 LOC, 33 tokens]
├── [] README.md [101 LOC, 616 tokens]
