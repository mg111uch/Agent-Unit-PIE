...
### FILE_MAP Tree
├── sessions_analysis/ [574 LOC, 9551 tokens]
│   ├── [] session3.md [82 LOC, 851 tokens]
│   ├── [] session4.md [122 LOC, 1382 tokens]
│   ├── [] session1.md [41 LOC, 767 tokens]
│   ├── [] session2.md [63 LOC, 589 tokens]
│   ├── [] session5.md [45 LOC, 775 tokens]
│   ├── [] session6.md [108 LOC, 2222 tokens]
│   ├── [] session7.md [60 LOC, 1688 tokens]
│   └── [] session8.md [53 LOC, 1277 tokens]
...
├── codebase/ [54463 LOC, 344912 tokens]
...
│   ├── prompt_fragments/ [165 LOC, 3135 tokens]
│   │   ├── [] meta_playbook.md [7 LOC, 252 tokens]
...
│   │   ├── [] file_ops_workflow.md [16 LOC, 517 tokens]
...
│   ├── agent_core/ [8500 LOC, 72797 tokens]
│   │   ├── server/ [752 LOC, 5781 tokens]
│   │   │   ├── [] ws_handler.py [359 LOC, 2731 tokens]
│   │   │   ├── [] routes.py [124 LOC, 1019 tokens]
│   │   │   ├── [] auth.py [36 LOC, 230 tokens]
│   │   │   ├── [] __init__.py [146 LOC, 1110 tokens]
│   │   │   └── [] audit.py [87 LOC, 691 tokens]
│   │   ├── tools/ [3614 LOC, 34329 tokens]
│   │   │   ├── code_rag/ [830 LOC, 8313 tokens]
│   │   │   │   ├── [] tools.py [422 LOC, 4251 tokens]
...
│   │   │   ├── [] meta_ops.py [134 LOC, 1282 tokens]
...
│   │   │   ├── [] __init__.py [457 LOC, 6663 tokens]
│   │   │   ├── [] git_ops.py [136 LOC, 919 tokens]
│   │   │   ├── [] file_ops.py [618 LOC, 5858 tokens]
│   │   │   ├── [] exec_ops.py [88 LOC, 672 tokens]
│   │   │   ├── [] expand_ops.py [9 LOC, 65 tokens]
│   │   │   ├── [] registry.py [299 LOC, 2530 tokens]
│   │   │   └── [] types.py [31 LOC, 192 tokens]
│   │   ├── loop/ [1527 LOC, 11786 tokens]
...
│   │   ├── planning/ [105 LOC, 705 tokens]
│   │   │   ├── [] local_planner.py [105 LOC, 705 tokens]
│   │   │   └── __init__.py
...
│   │   ├── [] mcp_server.py [180 LOC, 1254 tokens]
│   │   ├── [] auto_research.py [93 LOC, 680 tokens]
│   │   ├── [] prompts.py [112 LOC, 973 tokens]
│   │   ├── [] config.py [86 LOC, 874 tokens]
...
│   ├── [] temp_dedup_smoke.py [3 LOC, 15 tokens]
│   ├── __init__.py
│   ├── tui_output.txt
│   ├── [] config.json [82 LOC, 779 tokens]
...
│           ├── profile/
│           └── system_summery.md
├── system_devpt_reports/ [1850 LOC, 24210 tokens]
...
│   ├── agent_core/ [364 LOC, 6224 tokens]
│   │   ├── [] roadmap.md [18 LOC, 131 tokens]
│   │   ├── [] status.md [45 LOC, 1385 tokens]
│   │   └── [] README.md [301 LOC, 4708 tokens]
│   ├── [] TODO.md [41 LOC, 1093 tokens]
│   ├── [] FeatureIdeas.md [173 LOC, 2398 tokens]
│   └── [] FixesIssues.md [96 LOC, 1260 tokens]
├── [] opencode.json [16 LOC, 163 tokens]
├── [] Agent_graph.html [196 LOC, 3066 tokens]
├── context_dump.txt
├── [] AGENTS.md [30 LOC, 391 tokens]
├── code_dump.txt
├── [] codefiles_map.md [475 LOC, 8403 tokens]
