...
F: _get(obj,attr,default)→Any
   ↳Called by: F205:generate_stream,F205:_parse_interaction
   ↳Impact: 🟡MEDIUM (2 dependents) | Breaks: [F205:generate_stream],[F205:_parse_interaction]
F: _format_tool_for_gemini(tools)→Any
   ↳Called by: F205:generate_stream,F205:_generate_stateless,F205:generate
   ↳Impact: 🔴HIGH (5 dependents) | Breaks: [F205:generate_stream],[F205:_generate_stateless],[F205:generate]
   S: Normalize OpenAI-style, legacy gemini function_declarations, or flat tools.
F: _parse_interaction(res)→Any
   ↳Called by: F205:_generate_stateless,F205:_generate_stateful,F205:generate | Calls: F205:_get
   ↳Impact: 🔴HIGH (4 dependents) | Breaks: [F205:_generate_stateless],[F205:_generate_stateful],[F205:generate]
F: _messages_to_steps(messages)→Any
   ↳Called by: F205:_generate_stateless,F205:generate_stream,F205:_generate_initial_from_messages
   ↳Impact: 🔴HIGH (3 dependents) | Breaks: [F205:_generate_stateless],[F205:generate_stream],[F205:_generate_initial_from_messages]
...
C: GeminiProvider│[__init__,supports_stateful,generate,_generate_with_messages,_generate_initial_from_messages,_generate_stateful,_generate_stateless,generate_stream]
   ...
   ↳Calls: F205:_format_tool_for_gemini,F205:_messages_to_steps,F205:_parse_interaction
   ...
   F: generate_stream(self,prompt,model,system_prompt,conversation_id,temperature,max_tokens,tools,messages)→Any
   ↳Calls: F205:_format_tool_for_gemini,F205:_get,F205:_messages_to_steps
---
...
F: _convert_messages_to_openai(messages)→Any
   ↳Called by: F202:generate,F202:generate_stream
   ↳Impact: 🟡MEDIUM (2 dependents) | Breaks: [F202:generate],[F202:generate_stream]
