...
F: _get(obj,attr,default)→Any
   ↳Called by: F362:generate_stream,F362:_parse_interaction
   ↳Impact: 🟡MEDIUM (2 dependents) | Breaks: [F362:generate_stream],[F362:_parse_interaction]
F: _format_tool_for_gemini(tools)→Any
   ↳Called by: F362:_generate_stateless,F362:generate,F362:generate_stream
   ↳Impact: 🔴HIGH (5 dependents) | Breaks: [F362:_generate_stateless],[F362:generate],[F362:generate_stream]
   S: Normalize OpenAI-style, legacy gemini function_declarations, or flat tools.
F: _parse_interaction(res)→Any
   ↳Called by: F362:_generate_stateful,F362:_generate_stateless,F362:generate | Calls: F362:_get
   ↳Impact: 🔴HIGH (4 dependents) | Breaks: [F362:_generate_stateful],[F362:_generate_stateless],[F362:generate]
F: _messages_to_steps(messages)→Any
   ↳Called by: F362:generate_stream,F362:_generate_stateless
   ↳Impact: 🟡MEDIUM (2 dependents) | Breaks: [F362:generate_stream],[F362:_generate_stateless]
...
C: GeminiProvider│[__init__,generate,_generate_with_messages,_generate_initial_from_messages,_generate_stateful,_generate_stateless,generate_stream]
   ...
   ↳Calls: F362:_format_tool_for_gemini,F362:_parse_interaction
   ...
   ↳Calls: F362:_messages_to_steps,F362:_format_tool_for_gemini,F362:_parse_interaction
   ...
   ↳Calls: F362:_messages_to_steps,F362:_format_tool_for_gemini,F362:_get
---

F360│mock_provider.py│49
...
F359│openrouter_provider.py│160
...
F: _convert_messages_to_openai(messages)→Any
   ↳Called by: F359:generate_stream,F359:generate
   ↳Impact: 🟡MEDIUM (2 dependents) | Breaks: [F359:generate_stream],[F359:generate]
...
C: OpenRouterProvider│[__init__,generate,generate_stream]
   F: __init__(self,api_key,model)
   F: generate(self,prompt,model,system_prompt,conversation_id,temperature,max_tokens,tools,messages)→Any
   ↳Calls: F359:_convert_messages_to_openai
   F: generate_stream(self,prompt,model,system_prompt,temperature,max_tokens,tools,messages)→Any
   ↳Calls: F359:_convert_messages_to_openai
